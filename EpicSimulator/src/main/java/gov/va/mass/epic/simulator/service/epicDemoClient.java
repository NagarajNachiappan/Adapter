package gov.va.mass.epic.simulator.service;
...
import gov.va.mass.epic.simulator.model.HL7Data;

public class epicDemoClient {
    RestTemplate restTemplate;

    public epicDemoClient() {
     ...
     * post entity
     */
    public void postToAdapter() {
        HttpHeaders headers = new HttpHeaders();
        headers.setAccept(Arrays.asList(MediaType.ALL));
        headers.set("Content-Type", "application/hl7-v2+er7;charset=UTF-8");
        String msg = "MSH|^~\\&|HIS|RIH|EKG|EKG|199904140038||ADT^A01||P|2.2\r\n"
        ...
        String postUrl = "https://localhost:8443/Adapter/Gateway";
        ResponseEntity postResponse = restTemplate.postForEntity(postUrl, entity,  String.class);
        System.out.println(" ======================================================");
        System.out.println("Response for Post Request: \n" + postResponse.getBody());
        System.out.println(" ======================================================");
        System.out.println("Response Header for Post Request: \n" + postResponse.getHeaders().toString());
        System.out.println(" ======================================================");
    }
}
